...
class _TarjetaBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text((noticia.description != null) ? '${noticia.description}' : '', style: TextStyle(fontSize: 12),),
    );
  }
}
...
class _TarjetaTitulo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(noticia.title, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w200),),
    );
  }
}
